...
class ToolBarDashboard(wx.ToolBar):
    def __init__(self, parent, id):
        ...
        self.AddSeparator()
        self.AddLabelTool(ID_TEXT, "Text", wx.Bitmap(self.path_images + "text1.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.AddLabelTool(ID_PHOTO, "Photo", wx.Bitmap(self.path_images + "text1.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.AddLabelTool(ID_QUOTE, "Quote", wx.Bitmap(self.path_images + "text1.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.AddLabelTool(ID_LINK, "Link", wx.Bitmap(self.path_images + "text1.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.AddLabelTool(ID_CHAT, "Chat", wx.Bitmap(self.path_images + "text1.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.AddLabelTool(ID_AUDIO, "Audio", wx.Bitmap(self.path_images + "text1.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.AddLabelTool(ID_VIDEO, "Video", wx.Bitmap(self.path_images + "text1.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, "", "")
        self.AddSeparator()
