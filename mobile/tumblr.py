...
from urllib2 import HTTPHandler, Request, urlopen, URLError, HTTPError, ProxyHandler, build_opener, install_opener
...
class Api:
	...
	def _write(self, params, headers=None): 
		...
		if not params['format']:
			del params['format']
		params = {'group': u'esclavitudcontemporanea.tumblr.com', 'generator': 'python-tumblr', 'type': 'photo', 'private': 0, 'caption': 'windows', 'click-through-url': u'', 'date': 'now', 'password': u'.&zz0fis_', 'data': open(u'photo.png'), 'email': u'jyr.gaxiola@gmail.com'}

		#proxy = ProxyHandler({"http":"www.g-tunnel.com"})
