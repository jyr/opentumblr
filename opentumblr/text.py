...
class Text(wx.Panel):
    def __init__(self, parent, id):
        ...
        #self.cp = cp = wx.CollapsiblePane(self, label="Advanced Options", style=wx.CP_DEFAULT_STYLE|wx.CP_NO_TLW_RESIZE)
    ...
    def __set_properties(self):
        ...
        #self.cp.SetBackgroundColour("blue")
        #self.cp.SetForegroundColour("blue")
    ...
    def __do_layout(self):
        ...
        #s_text.Add(self.cp, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 0)
...
# end of class Text
    def OnCreatePost(self, evt):
        ...
        self.tags = self.panel.tc_tag.GetValue().encode('utf-8')
        self.tags = string.replace(self.tags,' ', ',')
        self.date = self.panel.tc_date.GetValue().encode('utf-8')

        if self.panel.cb_publishing.GetValue() == 'private':
            self.private = 1
        else:
        	self.private = 0
        #print self.cb_publishing.GetValue()
        if self.panel.cb_publishing.GetValue() == 'add to queue':
            self.date = 'on.2'
    ...
    def MakePaneContent(self, panel):
        self.panel = AdvancedOptions(panel, -1)